...
const playlist = ['diamond', 'ikk number', 'pasand bangi', 'phone maar di'];
...
function playSong(songId) {
    ...
    switch(songId) {
        case 'diamond':
            songPath = 'music/Diamond - Gurnam Bhullar.mp3';  // Replace with actual path
            break;
        case 'ikk number':
            songPath = 'music/Ikk Number Gurnam Bhullar 320 Kbps.mp3';  // Replace with actual path
            break;
        case 'pasand bangi':
            songPath = 'music/Pasand Bangi - Gurnam Bhullar.mp3';  // Replace with actual path
            break;
        case 'phone maar di':
            songPath = 'music/Phone-Maar-Di_320(PaglaSongs).mp3';  // Replace with actual path
            break;
        default:
